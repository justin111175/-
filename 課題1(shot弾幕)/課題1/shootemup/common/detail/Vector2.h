...
//内積を返す
template<class T>
inline Vector2Template<T> Dot(const Vector2Template<T>& va, const Vector2Template<T>& vb)
{
...
//外積を返す
template<class T>
inline Vector2Template<T> Cross(const Vector2Template<T>& va, const Vector2Template<T>& vb)
{
